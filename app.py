...
# 洗濯マークの意味リスト
mark_means = [
    '液温は30 ℃を限度とし、洗濯機で洗濯出来る', '液温は30 ℃を限度とし、洗濯機で非常に弱い処理が出来る', 
    '液温は30 ℃を限度とし、洗濯機で弱い処理が出来る', '液温は40 ℃を限度とし、洗濯機で洗濯出来る', 
    '液温は40 ℃を限度とし、洗濯機で非常に弱い処理が出来る', '液温は40 ℃を限度とし、洗濯機で弱い処理が出来る', 
    '液温は50 ℃を限度とし、洗濯機で処理が出来る', '液温は50 ℃を限度とし、洗濯機で弱い処理が出来る', 
    '液温は60 ℃を限度とし、洗濯機で処理が出来る', '液温は60 ℃を限度とし、洗濯機で弱い処理が出来る', 
    '液温は70 ℃を限度とし、洗濯機で処理が出来る', '液温は95 ℃を限度とし、洗濯機で処理が出来る', 
    '塩素系及び酸素系の漂白剤を使用して漂白ができる', '酸素系漂白剤の使用はできるが塩素系漂白剤は使用禁止', 
    'ドライクリーニング禁止', 'アイロン仕上げ禁止', 
    'タンブル乾燥禁止', 'ウエットクリーニング禁止', 
    '石油系溶剤によるドライクリーニグができる（溶剤に2％の水添加）', '石油系溶剤による弱いドライクリーニングができる', 
    ...
    '日陰のぬれつり干しがよい', '底面温度110 ℃を限度としてスチームなしでアイロン仕上げができる', 
    '底面温度150 ℃を限度としてアイロン仕上げができる', '底面温度200 ℃を限度としてアイロン仕上げができる', 
    '塩素系及び酸素系漂白剤の使用禁止', '家庭での洗濯禁止', 
    '低い温度でのタンブル乾燥ができる（排気温度上限60 ℃）', 'タンブル乾燥ができる（排気温度上限80 ℃）', 
    '非常に弱い操作のウエットクリーニングができる', 'ウエットクリーニング※ができる', 
    '弱い操作のウエットクリーニングができる'
]
